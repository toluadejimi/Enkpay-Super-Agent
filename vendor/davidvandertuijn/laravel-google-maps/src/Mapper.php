...
use Davidvandertuijn\LaravelGoogleMaps\Contracts\MappingInterface;
...
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperInstanceException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchKeyException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchLimitException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchResponseException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchResultException;
use Davidvandertuijn\LaravelGoogleMaps\Exceptions\MapperSearchResultMalformedException;
use Davidvandertuijn\LaravelGoogleMaps\Models\Location;
use Davidvandertuijn\LaravelGoogleMaps\Models\Map;
use Davidvandertuijn\LaravelGoogleMaps\Models\Streetview;
use Exception;
...
class Mapper extends MapperBase implements MappingInterface
{
    ...
    public function render($item = -1)
    {
        ...
        return $this->view->make('laravel-google-maps::mapper')
            ->withView($this->view)
    ...
    public function renderJavascript()
    {
        ...
        return $this->view->make('laravel-google-maps::javascript')
            ->withView($this->view)
