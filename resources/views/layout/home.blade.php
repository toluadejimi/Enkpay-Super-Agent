...
<link
  rel="shortcut icon"
  type="image/png"
  href="{{url('')}}/public/assets2/images/logos/favicon.png"
/>
...
<div class="brand-logo d-flex align-items-center justify-content-between">
  <a href="index.html" class="text-nowrap logo-img">
    <img
      src="{{url('')}}/public/assets2/images/logos/dark-logo.svg"
      class="dark-logo"
      alt="Logo-Dark"
    />
    <img
      src="{{url('')}}/public/assets2/images/logos/light-logo.svg"
      class="light-logo"
      alt="Logo-light"
    />
  </a>
...
>
  <div class="hstack gap-3">
    <div class="john-img">
      <img
        src="{{url('')}}/public/assets2/images/profile/user-1.jpg"
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      >
        ...
        <li class="nav-item dropdown">
          ...
          >
            <img
              src="{{url('')}}/public/assets2/images/svgs/icon-flag-en.svg"
              alt=""
              width="20px"
              height="20px"
          ...
          >
            <div class="message-body">
              ...
              >
                <div class="position-relative">
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-flag-cn.svg"
                    alt=""
                    width="20px"
                    height="20px"
                    class="rounded-circle object-fit-cover round-20"
              ...
              >
                <div class="position-relative">
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-flag-fr.svg"
                    alt=""
                    width="20px"
                    height="20px"
                    class="rounded-circle object-fit-cover round-20"
              ...
              >
                <div class="position-relative">
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-flag-sa.svg"
                    alt=""
                    width="20px"
                    height="20px"
                    class="rounded-circle object-fit-cover round-20"
...
<div class="message-body" data-simplebar>
  ...
  >
    <span class="me-3">
      <img
        src="{{url('')}}/public/assets2/images/profile/user-2.jpg"
        alt="user"
        class="rounded-circle"
        width="48"
        height="48"
  ...
  >
    <span class="me-3">
      <img
        src="{{url('')}}/public/assets2/images/profile/user-3.jpg"
        alt="user"
        class="rounded-circle"
        width="48"
        height="48"
  ...
  >
    <span class="me-3">
      <img
        src="{{url('')}}/public/assets2/images/profile/user-4.jpg"
        alt="user"
        class="rounded-circle"
        width="48"
        height="48"
  ...
  >
    <span class="me-3">
      <img
        src="{{url('')}}/public/assets2/images/profile/user-5.jpg"
        alt="user"
        class="rounded-circle"
        width="48"
        height="48"
...
<div class="py-6 px-7 mb-1">
  ...
  <div class="message-body">
    ...
    >
      ...
      >
        <img
          src="{{url('')}}/public/assets2/images/svgs/icon-account.svg"
          alt=""
          width="24"
          height="24"
        />
    ...
    <a href="app-email.html" class="py-8 px-7 d-flex align-items-center">
      ...
      >
        <img
          src="{{url('')}}/public/assets2/images/svgs/icon-inbox.svg"
          alt=""
          width="24"
          height="24"
        />
    ...
    <a href="app-notes.html" class="py-8 px-7 d-flex align-items-center">
      ...
      >
        <img
          src="{{url('')}}/public/assets2/images/svgs/icon-tasks.svg"
          alt=""
          width="24"
          height="24"
        />
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="m-n4 unlimited-img">
            <img
              src="{{url('')}}/public/assets2/images/backgrounds/unlimited-bg.png"
              alt=""
              class="w-100"
            />
          </div>
...
>
  <nav class="sidebar-nav scroll-sidebar">
    <div class="offcanvas-header justify-content-between">
      <img src="{{url('')}}/public/assets2/images/logos/favicon.ico" alt="" class="img-fluid" />
      <button
        type="button"
        class="btn-close"
          ...
          <ul aria-expanded="false" class="collapse first-level my-3">
            <li class="sidebar-item py-2">
              <a href="app-chat.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-chat.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="app-invoice.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-invoice.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="https://bootstrapdemos.adminmart.com/modernize/dist/main/app-cotact.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-mobile.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="app-email.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-message-box.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="page-user-profile.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-cart.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="app-calendar.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-date.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="app-contact2.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-lifebuoy.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <li class="sidebar-item py-2">
              <a href="app-notes.html" class="d-flex align-items-center">
                ...
                >
                  <img
                    src="{{url('')}}/public/assets2/images/svgs/icon-dd-application.svg"
                    alt=""
                    class="img-fluid"
                    width="24"
                    height="24"
            ...
            <ul class="px-8 mt-7 mb-4">
              ...
              <li class="sidebar-item py-2">
                <a class="fw-semibold text-dark" href="authentication-login.html"
  ...
  <div class="d-block d-xl-none">
    <a href="index.html" class="text-nowrap nav-link">
      <img src="{{url('')}}/public/assets2/images/logos/dark-logo.svg" width="180" alt="" />
    </a>
  </div>
  <a
    class="navbar-toggler nav-icon-hover p-0 border-0"
  ...
  <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
    <ul class="mb-0">
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{url('')}}/public/assets2/images/products/product-1.jpg"
            width="95"
            height="75"
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{url('')}}/public/assets2/images/products/product-2.jpg"
            width="95"
            height="75"
            class="rounded-1 me-9 flex-shrink-0"
            alt=""
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{url('')}}/public/assets2/images/products/product-3.jpg"
            width="95"
            height="75"
            class="rounded-1 me-9 flex-shrink-0"
            alt=""
